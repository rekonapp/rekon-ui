    ...
    return (
        <Box>
            <Dropzone
                ...
                >
                <Group justify="center" gap="xl" mih={!file && 227 || 139} style={{ pointerEvents: 'none', color: file && 'blue' }}>
                    <Box ta='center'>
                        <IconFaceId/>
                        <Dropzone.Accept>
            ...
            {
                file && (
                    <Button fullWidth radius='lg' mt='sm' color='blue.9' h={72} onClick={onFindClick}>Me encontre!</Button>
                )
            }
        </Box> 
    )
