                ...
                <Flex align='center' justify='space-between' gap='20px'>
                {
                    isMobile && (
                        <FileButton onChange={setFile} accept="image/png, image/jpeg" multiple>
                            ...
                            {(props) => <Button {...props} leftSection={<IconFaceId className={classes.iconButton}></IconFaceId>} radius='xl' bg='violet.9' h={58} fw='400' flex='2'> Me encontre! </Button>}
                        </FileButton>
                    ) || (
                        <Button onClick={onFindClick} radius='xl' leftSection={<IconFaceId className={classes.iconButton}></IconFaceId>} bg='violet.9' h={58} fw='400' flex='2'>Me encontre!</Button>
                    )
                }
