...
const PhotosCarousel = () => {
	...
	return (
        <Grid grow gutter="sm" mt="4rem">
            <Grid.Col lg="12">
                <Paper radius="md">
                    <Carousel height={320} withControls={false} plugins={[autoplay.current]} onMouseEnter={autoplay.current.stop} onMouseLeave={autoplay.current.reset}>
                        <Carousel.Slide radius="md">
                            <Image mah="320" radius="md" src={imagesByIndex[0]}></Image>
                        </Carousel.Slide>
                        <Carousel.Slide radius="md">
                            <Image mah="320" radius="md" src={imagesByIndex[1]}></Image>
                        </Carousel.Slide>
                        <Carousel.Slide radius="md">
                            <Image mah="320" radius="md" src={imagesByIndex[2]}></Image>
                        </Carousel.Slide>
                    </Carousel>
                </Paper>
            </Grid.Col>
